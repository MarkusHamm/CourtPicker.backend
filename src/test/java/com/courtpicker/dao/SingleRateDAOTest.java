...
public class SingleRateDAOTest extends BaseDAOTest {

    private SingleRateDAO dao;

    public SingleRateDAOTest() throws Exception {
        super();
        dao = new SingleRateDAO();
